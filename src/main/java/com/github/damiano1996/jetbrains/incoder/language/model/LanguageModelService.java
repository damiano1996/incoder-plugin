...
public interface LanguageModelService {
    ...
    ThrowableComputable<ChatLanguageModelClient, LanguageModelException> createChatClient(
            ChatSettings.State settings, LanguageModelParameters parameters);

    ThrowableComputable<ChatLanguageModelClient, LanguageModelException>
            createChatClientWithDefaultSettings(LanguageModelParameters parameters);

    ThrowableComputable<InlineLanguageModelClient, LanguageModelException> createInlineClient(
            InlineSettings.State settings, LanguageModelParameters parameters);

    ThrowableComputable<InlineLanguageModelClient, LanguageModelException>
